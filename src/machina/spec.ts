...
export const AAM_CLAIMS: VerifiableClaim[] = [
  ...
  },
  {
    id: 'max-turns',
    component: 'limit',
    description: 'T_max — the halting bound that makes the REAL machine decidable (150 turns by default, flat: no shape-based ladder and no adaptive widening), unlike the unbounded theoretical AAM. Cumulative spend across conversation segments is bounded separately by SessionBudget.',
