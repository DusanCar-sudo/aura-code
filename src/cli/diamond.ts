...
// The hero's widest row is `indent + mark + gutter + wordmark`; the extra
// column keeps it inside the TUI's one-column right margin, which would
// otherwise reflow that row when the banner is written to the scroll region.
