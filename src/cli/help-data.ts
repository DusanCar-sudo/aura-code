...
export const HELP_TEXT = [
  ...
  '  :sessions all           List saved sessions across every project',
  '  :resume                 Resume the latest session (this project, else anywhere)',
  '  :resume <id>            Resume a session by ID (searches all projects)',
  ...
  '',
  '  :effort [level]         Reasoning effort for this model; no arg shows the current one',
  '',
  '  ── Workflows ─────────────────────────────────────',
  ...
  '  :marathon [task]        Flag a long haul (24h, lapses on its own) and run task; off | status',
  '  :nerds [topic]          One writer at a time, readers parallel; runs topic. off | status',
  '',
  '  ── Memory / Side ─────────────────────────────────',
  ...
  '  :graph extract          Extract perception → graphify-out/graph.json',
  '  :graph refresh          Re-extract and reload the codebase graph',
  '  :plans                  List saved execution plans',
  '  :viz, :dashboard        Generate and open the memory dashboard',
  '  :viz all                Cross-project dashboard — every project Aura has a graph for',
  '  :doctor                 Scan Aura itself for issues (build, config, deps, env)',
  '  :doctor --fix           Scan and attempt auto-repairs',
  '  :stats, /stats          Session status: model, turns, tokens, cost (alias: /usage)',
  ...
  '                          (the stats family answers to both : and / prefixes)',
  '',
  '  ── General ──────────────────────────────────────',
  '  :help                   This list',
  '  :quit, :q, /exit        Exit',
