...
const REGISTRY: RegistryExpectation[] = [
  ...
  { prefix: 'kimi/', model: 'kimi/kimi-k3', family: 'kimi',
  ...
  { prefix: 'cerebras/', model: 'cerebras/llama-3.3-70b',
    family: 'cerebras', keyEnv: 'CEREBRAS_API_KEY',
    baseUrl: 'https://api.cerebras.ai/v1' },
  { prefix: 'sambanova/', model: 'sambanova/Meta-Llama-3.3-70B-Instruct',
    family: 'sambanova', keyEnv: 'SAMBANOVA_API_KEY',
  ...
  { prefix: 'mistral/', model: 'mistral/codestral-latest', family: 'mistral',
    keyEnv: 'MISTRAL_API_KEY', baseUrl: 'https://api.mistral.ai/v1',
    baseUrlEnv: 'MISTRAL_BASE_URL' },
  { prefix: 'together/', model: 'together/meta-llama/Llama-3.3-70B-Instruct-Turbo', family: 'together',
    keyEnv: 'TOGETHER_API_KEY', baseUrl: 'https://api.together.xyz/v1',
    baseUrlEnv: 'TOGETHER_BASE_URL' },
  { prefix: 'cohere/', model: 'cohere/command-r-plus-08-2024', family: 'cohere',
    keyEnv: 'COHERE_API_KEY', baseUrl: 'https://api.cohere.com/v2',
